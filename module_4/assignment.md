...
- [✔️ ]  Go to [Deep Note](https://deepnote.com/) and create a free account if you haven't already.
...
- [ ✔️] In Deep Note, create a new project.
- [✔️ ] Upload the `.csv` file into your project.
